...
export default async function OpsOrderDetailPage({ params }: { params: { orderNo: string } }) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-2 text-sm">
                ...
                <Row k="结算方式" v={order.dealer.paymentMethod} />
            ...
            <Card>
              ...
              <CardContent>
                ...
                {order.orderStatus !== "DRAFT" && !order.reviewer && (
                  <p className="text-sm text-muted-foreground mt-3">该订单尚未经过运营审核</p>
                )}
              </CardContent>
            </Card>
          )}
